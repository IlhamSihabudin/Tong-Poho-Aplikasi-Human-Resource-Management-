		...
		<div class="card">
			...
			<div class="card-body">
				...
				<div class="form-group text-left">
					...
					<input type="password" id="password-field"  name="new_password" value="" placeholder="" class="form-control">
			...
			<div class="card-footer">
				@csrf
				<button type="submit" class="btn btn-primary btn-block">Changes</button>
			</div>
			</form>
		</div>
	</div>
