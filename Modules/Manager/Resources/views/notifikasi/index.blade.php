...
@section('content')
    <div class="row">
        ...
        <div class="col-md-12 mt-3">
            <div class="card">
                <div class="card-header bg-warning" style="padding: 2px;"></div>
                <div class="card-header white">
                    <div class="row align-items-center justify-content-between">
                        <div style="padding-left: 10px">
                            <h1 class="h1-responsive" style="font-size: 20pt;">Pending List</h1>
                        </div>
                    </div>
                </div>
                            ...
                            <tbody align="center">
                                @foreach($data_pending as $item)
                                    <tr>
                                        ...
                                        <td><span class="badge badge-warning">{{ $item->confirm_status }}</span></td>
